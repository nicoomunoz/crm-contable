    ...
    <div className="flex min-h-screen bg-gray-50 text-slate-900 font-sans">
      <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col fixed h-full border-r border-slate-800">
        ...
        <nav className="flex-1 p-4 space-y-1">
          <Link href="/dashboard" className="flex items-center gap-3 p-3 hover:bg-slate-800 hover:text-white rounded-xl transition duration-200">
            <LayoutDashboard size={20} />
            <span className="font-medium">Inicio / Resúmen</span>
          </Link>
          <Link href="/clientes" className="flex items-center gap-3 p-3 hover:bg-slate-800 hover:text-white rounded-xl transition duration-200">
            <Users size={20} />
            <span className="font-medium">Clientes</span>
          </Link>
          <Link href="/tramites" className="flex items-center gap-3 p-3 hover:bg-slate-800 hover:text-white rounded-xl transition duration-200">
            <Briefcase size={20} />
            <span className="font-medium">Trámites</span>
          </Link>
          <Link href="/historial" className="flex items-center gap-3 p-3 hover:bg-slate-800 hover:text-white rounded-xl transition duration-200">
            <History size={20} />
            <span className="font-medium">Historial</span>
          </Link>
          <Link href="/perfil" className="flex items-center gap-3 p-3 hover:bg-slate-800 hover:text-white rounded-xl transition duration-200">
            <Settings size={20} />
